...
@Component({
  selector: 'app-regional-cluster',
  templateUrl: './regional-cluster.component.html',
  styleUrls: ['./regional-cluster.component.css']
})
export class RegionalClusterComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.barChart= new Chart("regionalBar", {
      type: 'bar',
      options: {
        responsive: true,
        scales:{
